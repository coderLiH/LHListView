...
@interface LHListView () <UICollectionViewDelegateFlowLayout,UICollectionViewDelegate, UICollectionViewDataSource, LHRefreshViewDelegate>
...
+ (instancetype)listViewWithDisplayWidth:(CGFloat)displayWidth {
    ...
    listView.backgroundView = [[UIView alloc] init];
...
- (LHRefreshView *)refreshView {
    if (!_refreshView) {
        ...
        _refreshView.frame = CGRectMake(0, 0, _displayWidth, List_Refresh_Height);
